                                    ...
                                    <div class="col-md-4 mb-4">
                                        <div class="Ha card my-specific-card {{$r->ISDELETE==0 ? 'disabled':''}}">
                                            ...
                                            <div class="card-info">
                                                ...
                                                <p class="card-text"><i class="fa-solid fa-location-dot" style="color:#74C0FC;margin-right:10px;"></i><span style="font-weight:bold;">Vị
                                                        trí:</span>
                                                    {{ $r->VITRI }}
                                                </p>
                                                <p class="card-text"><i class="fa-solid fa-hotel" style="color:#74C0FC;margin-right:10px;"></i><span style="font-weight:bold;">Diện
                                                        tích:</span>
                                                    {{ $r->DIENTICH }}
                                                </p>


                                                <p class="card-text"><i class="fa-solid fa-box" style="color:#74C0FC;"></i><span style="font-weight:bold;margin-left:10px;">Sức chứa tối
                                                        đa:</span> {{ $r->SUCCHUA }}</p>
                                                <p class="card-text">
