    ...
    <section class="section faq">
        <div class="row">
            <div class="col-lg-6">
                ...
                <div class="card basic" style="border-radius: 20px">
                    <div class="card-body">
                        ...
                        <div class="pt-2">
                            ...
                            <p>Nguyễn Thị Thu Hà - 2001215884</p>
                        </div>

                        <div class="pt-2">
                            <h6>Những thành viên trong nhóm?</h6>
                            <p>Nguyễn Phương Điền- 2001215884</p>
                        </div>
                        ...
                        <div class="accordion accordion-flush" id="faq-group-2">
                            ...
                            <div class="accordion-item">
                                ...
                                <div id="faqsTwo-5" class="accordion-collapse collapse" data-bs-parent="#faq-group-2">
                                    <div class="accordion-body">
                                        Trần Hoàng Anh Khôi, Nguyễn Thị Thu Hà, Nguyễn Phương Điền
                                    </div>
                                </div>
                            </div>
