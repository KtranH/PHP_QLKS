                                ...
                                <tbody>
                                    @foreach ($category as $item)
                                        <tr>
                                            ...
                                            @endif
                                            <td><button type="button" class="btn btn-info" style="border-radius:20%;margin-right:20px;color:white;box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;background-color:#74C0FC"><i class="fi fi-rr-file-edit"></i></button><button type="button" class="btn btn-danger" style="border-radius:20%; box-shadow: rgba(0, 0, 0, 0.24) 0px 3px 8px;"><i class="fi fi-br-cross"></i></button></td>
                                        </tr>              
                                    @endforeach
                                </tbody>
                              </table>
                            ...
                            <div class="tab-pane fade show profile-overview" id="lichSuDatPhong">
                             ...
                             <!-- Form hiển thị thêm loại phòng -->
                                ...
                                @csrf
                                  ...
                                  <div style="width:100%; display: flex;justify-content:space-around;margin-bottom: 20px">
                                    <div style="width:100%">
                                        <label for="company" class="col-md-4 col-lg-3 col-form-label"  style="font-weight:bold">Số lượng:</label>
                                        <div class="col-md-8 col-lg-9">
                                        <input name="quanlity" type="number" min = 1 class="form-control" id="company" style="box-shadow: rgba(0, 0, 0, 0.16) 0px 1px 4px;" required>
                                  ...
                                  <div class="row mb-3">
                                    <div class="col-md-8 col-lg-9">
                                        <img id="avatarPreview3" src="https://media.designcafe.com/wp-content/uploads/2023/07/05141750/aesthetic-room-decor.jpg" alt="Profile" style="max-width:120px;">
                                    </div>
                                  </div>
                                  <div class="row mb-3">
                                    <label for="Country" class="col-md-4 col-lg-2 col-form-label"  style="font-weight:bold">Đường dẫn hình ảnh 3:</label>
                                    <div class="col-md-8 col-lg-9">
                                      <input name="image3" type="text" class ="form-control" id="image3" style="box-shadow: rgba(0, 0, 0, 0.16) 0px 1px 4px;" required>
                                      <div class="invalid-feedback">Hình ảnh không hợp lệ</div>
                                    </div>
                                  </div>
