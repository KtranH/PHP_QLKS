                        ...
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="bg-white" style="display:flex; flex-wrap:wrap">
                                    ...
                                    <?php $__currentLoopData = $roomsByCategories; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                    ...
                                    <div class="card"
                                        ...
                                        <img src="<?php echo e($firstImage); ?>" style="width:288px;height:192px" class="card-img-top"
                                            alt="...">
                                        <div class="card-body">
                                            <h5 class="card-title"><?php echo e($r->TENPHONG); ?></h5>
                                            <p class="card-text" style="font-weight: bold;"><?php echo e($r->VITRI); ?></p>
                                            <p class="card-text">
                                                <?php
                                            ...
                                            <p class="card-text rend-cost"><?php echo e($format_cost); ?><sup>đ</sup>
                                                <span class="reduced-cose"><?php echo e($format_promition); ?></span><sup
                                                    style="color:gray;">đ</sup>
                                            </p>
                                            <a href="#" class="btn btn-primary"
                                                style="background-color: #74C0FC; border:none">Xem chi tiết</a>
                                        </div>
                                    </div>
...
<?php echo $__env->make('container', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\PHP_QLKS_BRANCHS_THUHA\resources\views/User/Room/roombyCategories.blade.php ENDPATH**/ ?>