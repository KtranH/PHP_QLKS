            ...
            <div class="col-lg-8">
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Loại phòng <span>/Loại theo giá từ cao đến thấp</span></h5>
                                <div class="row bg-white" style="padding:20px;">
                                    <?php $__currentLoopData = $priceHighLow; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
...
<?php echo $__env->make('container', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Zalo\PHP_QLKS_BRANCHS_THUHA\resources\views/User/Room/categoryByPriceHighLow.blade.php ENDPATH**/ ?>