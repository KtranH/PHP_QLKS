    ...
    <ul class="sidebar-nav" id="sidebar-nav">
        ...
        <li class="nav-item">
            ...
            <ul id="components-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                <li>
                    <a href="<?php echo e($url = route('all.category')); ?>">
                        <i class="bi bi-circle"></i><span>Tât cả loại phòng</span>
                    </a>
                </li>
                <li>
                    <a href="<?php echo e($url = route('loai.caocap')); ?>">
                        <i class="bi bi-circle"></i><span>Loại cao cấp</span>
                    </a>
                </li>
                <li>
                    <a href="<?php echo e($url = route('loai.phothong')); ?>">
                        <i class="bi bi-circle"></i><span>Loại Phổ Thông</span>
                    </a>
                </li>
                <li>
                    <a href="<?php echo e($url = route('loai.giare')); ?>">
        ...
        <li class="nav-item">
            ...
            <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
                <li>
                    <a href="<?php echo e(route('price.high')); ?>">
...
</aside><!-- End Sidebar--><?php /**PATH D:\Zalo\PHP_QLKS_BRANCHS_THUHA\resources\views/sideBar.blade.php ENDPATH**/ ?>