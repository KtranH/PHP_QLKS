            ...
            <div class="col-lg-8">
                <div class="row">
                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                <h5 class="card-title">Loại phòng <span>/Loại theo giá từ thấp đến cao</span></h5>
                                <div class="row bg-white" style="padding:20px;">
                                    <?php $__currentLoopData = $priceLowHigh; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $r): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <?php
                                    ...
                                    <div class="col-md-6 mb-4">
                                        <div class="test card my-specific-card">
                                            ...
                                            <div class="card-info">
                                                <p class="text-title"> <?php echo e($r->TENLOAIPHONG); ?></p>
                                                <p class="card-text"><span style="font-weight:bold;">Mô tả:</span>
                                                    <?php echo e(Str::limit($r->MOTA, 30, $end='...')); ?>

                                                </p>
                                                <p class="card-text"><span style="font-weight:bold;">Vị trí:</span>
                                                    <?php echo e($r->VITRI); ?>

                                                </p>
                                                <p class="card-text"><span style="font-weight:bold;">Sức chứa tối
                                                        đa:</span> <?php echo e($r->SUCCHUA); ?></p>
...
<?php echo $__env->make('container', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\Zalo\PHP_QLKS_BRANCHS_THUHA\resources\views/User/Room/categoriesByPriceLowHigh.blade.php ENDPATH**/ ?>